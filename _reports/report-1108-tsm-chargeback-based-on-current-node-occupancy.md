---
title: "TSM Chargeback Based on Current Node Occupancy"
report_id: 1108
rtd_name: "TSM Chargeback Based on Current Node Occupancy.rtd"
description: "TSM Chargeback based on Current Node Occupancy applies a user defined cost per GB, to the total amount occupied data for each protected filespace on each node."
problem_statement: "Want to be able to chargeback per node based on current occupancy by prompting for per GB cost."
