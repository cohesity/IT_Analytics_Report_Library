---
title: "HPE 3PAR LUNs with/without DeDup Cost Modeling Detail"
report_id: 1229
rtd_name: "HPE 3Par LUNs with_without DeDup Cost Modeling Detail.rtd"
description: "HPE 3PAR LUNs with/without DeDup Cost Modeling Detail"
problem_statement: "I need the ability to model my cost savings for LUNs that have DeDup enabled and optionally disable LUNs that have DeDup enabled but are not getting any DeDup benefit. I also need to model the performance impact of the overhead involved in DeDup, especially of LUNs that are not DeDuping well."
author: ""
